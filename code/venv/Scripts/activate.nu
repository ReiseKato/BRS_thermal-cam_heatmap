...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'S:\BRS Motorsport\workplace_priv\BRS_thermal-cam_heatmap\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'S:\BRS Motorsport\workplace_priv\BRS_thermal-cam_heatmap\venv\Scripts\deactivate.nu'
